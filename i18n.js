...
window.JP_UI = {
  en: {
    ...
    elim_badge: 'What we remove', elim_desc: 'The worst parts of job searching — gone for good.',
    ...
    testi_badge_1: 'Verified Hire', testi_featured: 'Featured Story', testi_badge_3: 'Success Story',
  ...
  fr: {
    ...
    elim_badge: 'Ce que nous supprimons', elim_desc: 'Les pires aspects de la recherche d\'emploi — éliminés.',
    ...
    testi_badge_1: 'Embauche vérifiée', testi_featured: 'Témoignage vedette', testi_badge_3: 'Histoire réussie',
  ...
  de: {
    ...
    elim_badge: 'Was wir entfernen', elim_desc: 'Die schlimmsten Teile der Jobsuche — für immer weg.',
    ...
    testi_badge_1: 'Verifizierte Einstellung', testi_featured: 'Highlight-Geschichte', testi_badge_3: 'Erfolgsgeschichte',
  ...
  es: {
    ...
    elim_badge: 'Lo que eliminamos', elim_desc: 'Lo peor de buscar empleo — eliminado de verdad.',
    ...
    testi_badge_1: 'Contratación verificada', testi_featured: 'Historia destacada', testi_badge_3: 'Historia de éxito',
